...
const navItems = [
    ...
    { name: "Pagos", href: "/recibos", icon: Wallet },
...
export default function MobileNav() {
    ...
    return (
        <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-100 px-6 py-4 flex justify-between items-center z-[100] shadow-[0_-10px_40px_rgba(0,0,0,0.02)]">
            {navItems.map((item) => {
