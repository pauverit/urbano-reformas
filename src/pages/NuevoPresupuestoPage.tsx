...
export default function NuevoPresupuestoPage() {
    ...
    const finalizarYCompartir = async () => {
        ...
        // En Vite/Capacitor/Mobile, navigator.share es la mejor opción. 
        // En escritorio simplemente guardamos.
        try {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-12 pb-24 page-transition">
            <div className="flex flex-col gap-2">
                <h1 className="text-4xl font-black text-slate-900 tracking-tight uppercase">Nuevo Presupuesto</h1>
                <p className="text-blue-500 font-bold uppercase text-[10px] tracking-widest italic">Inteligencia Artificial aplicada a la Reforma</p>
            </div>
            ...
            {!datosAnalisis ? (
                    ...
                    <div className="space-y-8">
                        <div className="bg-blue-600 p-10 rounded-3xl text-white border-none shadow-2xl shadow-blue-100 flex flex-col gap-6">
                            <div className="flex items-center gap-4">
                                ...
                                <h3 className="font-black text-xl tracking-tight uppercase">IA de Visión</h3>
                            </div>
                            <p className="text-blue-100 text-[10px] leading-relaxed font-bold uppercase tracking-widest">
                            ...
                            <ul className="text-[10px] text-blue-200 space-y-3 font-black uppercase tracking-widest opacity-80 mt-2">
                        ...
                        <div className="bg-white p-8 rounded-3xl border border-blue-50 shadow-sm">
                            <div className="flex gap-4">
                                ...
                                <p className="text-[10px] text-slate-400 font-black leading-relaxed italic uppercase">
                ...
                <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                    <div className="bg-emerald-500 text-white p-6 rounded-3xl flex items-center justify-between shadow-xl shadow-emerald-50">
                        <div className="flex items-center gap-4">
                            <Sparkles size={24} className="text-emerald-200" />
                            <span className="font-black uppercase tracking-[0.2em] text-[10px]">Análisis con Gemini 1.5 Flash Completado</span>
                        </div>
                        ...
                        <div className="premium-card p-10 space-y-6">
                            ...
                            {firmaCliente ? (
                                ...
                                >
                                    ...
                                    <span className="font-black uppercase text-[10px] tracking-[0.2em]">Pulsar para firmar en pantalla</span>
                                </button>
                            )}
                        </div>

                        <div className="bg-blue-600 p-10 rounded-[40px] shadow-2xl shadow-blue-100 flex flex-col justify-center text-center space-y-6 text-white text-md">
                            <h3 className="text-2xl font-black tracking-tight uppercase">¿Todo listo?</h3>
                            <p className="text-blue-100 text-[10px] font-black tracking-widest uppercase">Genera el PDF oficial con la firma del cliente y compártelo al instante.</p>
                            <button
            ...
            {presupuestoFinalizado && (
                <div className="fixed inset-0 bg-emerald-500/95 backdrop-blur-xl z-[200] flex flex-col items-center justify-center text-white p-10 text-center space-y-8 animate-in fade-in duration-500">
                    ...
                    <h2 className="text-5xl font-black tracking-tighter uppercase">¡Presupuesto Enviado!</h2>
                    <p className="max-w-md text-emerald-100 font-bold text-lg uppercase tracking-tight">El documento PDF ha sido generado y compartido correctamente.</p>
                    <button
                        onClick={() => navigate("/panel")}
                        className="bg-white text-emerald-600 px-10 py-5 rounded-3xl font-black uppercase text-[10px] tracking-widest shadow-xl"
                    >
                        Volver al Panel
                    </button>
                </div>
